...
This outlines how to propose a change to saros. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("NIFU-NO/saros", fork = TRUE)`.
...
of Conduct](https://nifu-no.github.io/saros/CODE_OF_CONDUCT.md). By
