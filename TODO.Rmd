...
# Version 1.0
1   From AGU script and elsewhere collect common functions:
        Sanitize factor labels
        Check beforehand that there are no " - " in all data_prep scripts
