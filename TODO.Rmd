...
1   if(all(is.na(chapter_overview_section$.variable_name_dep)) && 
    rlang::is_string(dots$mesos_group)) => all chapter_overview_section becomes NA

1   Generally, should allow users to adjust as much as possible later. Make less absolute changes?
...
2   Add to chapter yaml template: format: nifudocx-docx
