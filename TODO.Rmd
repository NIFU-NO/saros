...
- bi_intcat_sigtest (by_n == 2) => "mean"/"chisq"...?!?!
- sigtest-related
    - show_if_p_below
...
- prep_cat_plot_pdf: Implement n_right_side for when tooltips are unavailable
- avoid the default group_by = "col_group" or make it "hidden" (without headings)
