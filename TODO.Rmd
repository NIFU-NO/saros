...
-   In refine, handle " and ' interchangably for dep/indep cells (matches, etc), handle spaces, 
...
-   if .categories %in% names(colour_palette), use associated colour
    -   Bruk så fargepalett på resten
+   colour_palette_ordinal, colour_palette_nominal 

-   separate colour_palette for different needs: chapter, designated_type, .variable_role, ... 
...
-   Separate subfolders for PNG, DOCX (grraphs), TXT, XLSX
