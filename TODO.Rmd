...
+ Chapters need chapter_number as part of their filename, otherwise disordered
+   chapter_number is one too high
- BI_index.qmd
-   colour palette does not seem to be respected
+   Reports/Report => Rapporter/Rapport
-   Sharepoint!!!
    - Shorten chunk names
