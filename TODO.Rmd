...
- implement uni_plot_mean_html and bi_plot_mean_html
...
- Always hide heading if nothing to show within that level
...
- Allow a autonumberer for sections (inside gen_qmd_structure) - or can this be done by Quarto automatically?
