...
2   unused levels seem to cause confusion in hide_legend and colours. and tables
...
3   incorrect numbers?
3   If only single question, simplify output!
3   respecting data_label
3   long batteries not respecting n_top_bottom?
3   must explain that it is sum of upper categories
3   bool: str_to_sentence, asis
