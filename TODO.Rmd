...
- Might be hard to store in memory/Rds the docx-stuff.
...
- Save not only Rds-files but also png/docx copies of tables/plots for manual inspection. Requires figuring out plot() within package
