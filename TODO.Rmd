...
# Version 1.0
1   Must allow chapter in chapter_overview with NA in dep/indep: These are manually created chapters. Numbering must still work.
1   Methodize
...
1   SSN: Avoid H2023
1   Argument: drop empty sections before rendering (in the render_site())
...
# Structure
3 Look into whether top-level-division can be used to avoid having both chapters and index rendered in separate files. Or ask around
