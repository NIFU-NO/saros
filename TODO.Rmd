...
1   CriThiSE: Fails, possibly due to no NA chapter?
1   chapter datasets do not contain data and data format is weird?

2   (facet strips 90 deg)
        Generally, should allow users to adjust as much as possible later. Make less absolute changes?
...
2   In nifudocx.docx, turn off numbering? or opposite?
2   cat_*_plot_docx:
