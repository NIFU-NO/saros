...
1. File location:
  ...
  3. Leave all files associated with the chapter in the same folder, also versions sent to quality assurance, etc. Everything in one place. Feel free to use subfolders to keep things tidy.
