...
- [`fig_height_h_barchart2()`](https://nifu-no.github.io/saros/reference/fig_height_h_barchart2.md)
  [`fig_height_h_barchart2.ggplot()`](https://nifu-no.github.io/saros/reference/fig_height_h_barchart2.md)
  [`fig_height_h_barchart2.ms_chart()`](https://nifu-no.github.io/saros/reference/fig_height_h_barchart2.md)
  [`fig_height_h_barchart2.default()`](https://nifu-no.github.io/saros/reference/fig_height_h_barchart2.md)
  : Estimate figure height for a horizontal bar chart
...
- [`insert_text()`](https://nifu-no.github.io/saros/reference/insert_text.md)
  : Insert Text from a Data Frame by Chunk Name

## Detect the current output format

- [`output_format()`](https://nifu-no.github.io/saros/reference/output_format.md)
  : Detect the Current Output Format
