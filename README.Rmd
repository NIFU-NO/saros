...
library(saros)
library(dplyr)
render_saros_report(chapter_overview = ex_survey_ch_overview, data = ex_survey1, path = "testreport")

browseURL("testreport/index.qmd")
quarto::quarto_render("testreport/index.qmd")
browseURL("testreport/index.html")
```
