...
[![R-CMD-check](https://github.com/sda030/saros/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/sda030/saros/actions/workflows/R-CMD-check.yaml) 
[![Codecov test coverage](https://codecov.io/gh/sda030/saros/branch/main/graph/badge.svg)](https://app.codecov.io/gh/sda030/saros?branch=main)
...
devtools::install_github("sda030/saros")
```
