...
#'
#' @param ymlthis_config A ymlthis-object. Defaults will be obtained from getOptions("ymlthis.default_options") if NULL.
...
gen_qmd_index <-
  function(
    ...
    check_yml(ymlthis_config)



    if(is.null(ymlthis_config)) {
      yml_section <-
