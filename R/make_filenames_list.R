make_filenames_list <- function(element_folderpath_relative,
  ...
  filepath$rel[[tabular_format]] <- file.path(efr, stringi::stri_c(ignore_null=TRUE, filename_prefix, ".xlsx"))
  ...
  filepath$abs[[tabular_format]] <- file.path(efa, stringi::stri_c(ignore_null=TRUE, filename_prefix, ".xlsx"))
