...
-   **New function**: `txt_from_cat_mesos_plots()` to generate textual summaries from two categorical mesoscale plots, highlighting significant differences in selected categories between groups.
